...
(cl:in-package fake_ar_publisher-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ARMarker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ARMarker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fake_ar_publisher-msg:<ARMarker> is deprecated: use fake_ar_publisher-msg:ARMarker instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ARMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_ar_publisher-msg:header-val is deprecated.  Use fake_ar_publisher-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <ARMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_ar_publisher-msg:id-val is deprecated.  Use fake_ar_publisher-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <ARMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_ar_publisher-msg:pose-val is deprecated.  Use fake_ar_publisher-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <ARMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fake_ar_publisher-msg:confidence-val is deprecated.  Use fake_ar_publisher-msg:confidence instead.")
  (confidence m))
