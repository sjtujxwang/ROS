...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/wjx/new/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/wjx/new/devel)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/wjx/new/install)
...
if(NOT "/home/wjx/new/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wjx/new/src/myworkcell_core/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;fake_ar_publisher;message_runtime;geometry_msgs;tf;moveit_ros_planning_interface;ur5_demo_descartes;descartes_trajectory;descartes_planner;descartes_utilities;trajectory_msgs")
